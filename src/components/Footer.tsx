...
function Footer() {
  ...
  return (
    <>
      {/* Horizontal Line Above Footer (aligned to footer width) */}
      <div className="container mx-auto px-4">
        <div className="border-t border-gray-300 dark:border-gray-600 mt-16"></div>
      </div>

      {/* Footer Content */}
      <footer className="text-gray-600 dark:text-gray-300 mt-5">
        ...
        <div className="container mx-auto px-4">
          <div className="container mx-auto px-4">
            ...
            >
              ...
              {/* <div className="md:col-span-12 text-center md:text-center border-t border-gray-200 dark:border-gray-700 pt-8 mt-4">
              <Link
                href="/"
